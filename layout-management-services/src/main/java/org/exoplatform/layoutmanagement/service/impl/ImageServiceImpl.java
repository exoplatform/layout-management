...
public class ImageServiceImpl implements ImageService {
  ...
  private static final Log LOG = ExoLogger.getLogger(ImageServiceImpl.class);

  private FileService      fileService;

  private UploadService    uploadService;

  public ImageServiceImpl(FileService fileService, UploadService uploadService) {
    this.fileService = fileService;
    this.uploadService = uploadService;
  }

  @Override
  public Long getImage(String remoteId, String uploadFileId) {
    try {
      ...
      LOG.error("Can not store image for " + remoteId, ex);
      return null;
    }
  }
  ...
  public InputStream getImageStream(String fileId) {
    return getImageImageAsStream(fileId);
  }

  public InputStream getImageImageAsStream(String fileId) {
    try {
