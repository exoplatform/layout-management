...
public class UINavigationNodeSelector extends UIContainer {
  ...
  public void initTreeData() throws Exception {
    ...
    try {
      this.rootNode = new TreeNode(edittedNavigation,
                                   userPortal.getNode(edittedNavigation,
                                                      navigationScope,
                                                      filterConfig,
                                                      null));
      ...
      context.getUIApplication()
             .addMessage(
                         new ApplicationMessage("UINavigationNodeSelector.msg." + NavigationError.NAVIGATION_NO_SITE.name(),
                                                null,
  ...
  public void save() {
    ...
    try {
      ...
      context.getUIApplication()
             .addMessage(
                         new ApplicationMessage("UINavigationNodeSelector.msg." + ex.getError().name(),
                                                null,
                                                ApplicationMessage.ERROR));
    }
  }
  ...
  public static class PasteNodeActionListener extends BaseActionListener<UIRightClickPopupMenu> {
    ...
    public void execute(Event<UIRightClickPopupMenu> event) throws Exception {
      ...
      if (isExistsInTree(sourceNode, targetNode)) {
        context.getUIApplication()
               .addMessage(new ApplicationMessage("UIPageNodeSelector.msg.paste.wrongLocation",
                                                  null,
      ...
      if (uiNodeSelector.findNode(sourceNode.getId()) == null) {
        context.getUIApplication()
               .addMessage(
                           new ApplicationMessage("UINavigationNodeSelector.msg.copiedNode.deleted",
                                                  null,
                                                  ApplicationMessage.WARNING));
