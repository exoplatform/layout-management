...
public class UIPageNodeForm extends UIFormTabPane {
  ...
  public UIPageNodeForm() throws Exception {
    ...
    UIFormCheckBoxInput<Boolean> uiDateInputCheck = new UIFormCheckBoxInput<Boolean>(SHOW_PUBLICATION_DATE, null, false);
    ...
    uiSettingSet.addUIFormInput(new UIFormStringInput("URI", "URI", null).setEditable(false))
                .addUIFormInput(new UIFormStringInput("name", "name", null).addValidator(MandatoryValidator.class)
                                                                           .addValidator(UserConfigurableValidator.class,
                                                                                         UserConfigurableValidator.PAGE_NAME))
  ...
  public void invokeGetBindingBean(Object bean) throws Exception {
    ...
    if (i18nizedLabels != null) {
      for (Locale key : i18nizedLabels.keySet()) {
        String locale = (key.getCountry() != null && !key.getCountry().isEmpty()) ? key.getLanguage() + "_" + key.getCountry()
                                                                                  : key.getLanguage();
      ...
      if (pageSelector.getPage() == null) {
        ...
        if (pageService.loadPage(pageContext.getKey()) == null) {
          ...
          String[] accessPermission =
                                    pageContext.getState()
                                               .getAccessPermissions() == null ? null
                                                                               : pageContext.getState()
                                                                                            .getAccessPermissions()
                                                                                            .toArray(new String[pageContext.getState()
                                                                                                                           .getAccessPermissions()
                                                                                                                           .size()]);
  ...
  static public class CreatePageActionListener extends EventListener<UIPageNodeForm> {
    public void execute(Event<UIPageNodeForm> event) throws Exception {
      ...
      PageState pageState = new PageState(uiPageTitle.getValue(),
                                          null,
                                          false,
                                          null,
